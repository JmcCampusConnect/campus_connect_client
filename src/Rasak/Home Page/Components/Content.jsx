...
{
    return (
        <div className="mt-10 h-screen  flex flex-row justify-between">
            <div className="w-1/2 flex flex-col pt-10 ">
                <div className='font-bold  text-5xl pt-16 '>
            ...
            <div className="w-1/2 h-full  flex flex-row  bg-[url('/src/assets/ig3.png')] rotate-160 bg-cover bg-center ">
